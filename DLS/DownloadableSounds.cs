...
namespace GotaSoundBank.DLS
{
    ...
    public class DownloadableSounds : IOFile
    {
        ...
        /// Waves.
        /// </summary>
        public List<RiffWave> Waves = new();
        ...
        {
            //Get waves.
            List<string> waveMd5s = new();
            Dictionary<int, string> newWaveIds = new();
            Dictionary<int, sbyte> tunings = new();
            Dictionary<int, byte> origPitches = new();
            Dictionary<int, uint> channelFlags = new();
        ...
        public override void Read(FileReader r2)
        {
            ...
            foreach (ListChunk c in (r.GetChunk("lins") as ListChunk).Chunks.Cast<ListChunk>())
            {
                ...
                //Read regions.
                foreach (ListChunk g in (c.GetChunk("lrgn") as ListChunk).Chunks.Cast<ListChunk>())
                {
